...
<div class="contenido">
  <div class="clearfix">
    ...
    <?php } ?>
      ...
      <?php } ?>
      <?php if( isset($recent_posts[4]) ){ $displayed[] = $recent_posts[4];?>
      <div class="principales">
        <a href="<?php echo get_permalink( $recent_posts[4]['ID'] ); ?>">
          <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $recent_posts[4]['ID'] ), 'nota-small' ); ?>
          <!-- <img src="http://lorempixel.com/400/75" alt="img"> -->
          <img src="<?php echo $img[0]; ?>" alt="img">
          <p class="elipseme"><?php echo $recent_posts[4]["post_title"]; ?></p>
        </a>
      </div>
      <?php } ?>
    </div>
