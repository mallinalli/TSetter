    ...
    <?php } ?>
      ...
      <?php if( isset($recent_posts[0]) ){ $displayed[] = $recent_posts[0];?>
        ...
        <a href="<?php echo get_permalink( $recent_posts[0]['ID'] ); ?>">
          <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $recent_posts[0]['ID'] ), 'nota-medium' ); ?>
          <!-- <img src="http://lorempixel.com/000/75" alt="img"> -->
          <img src="<?php echo $img[0]; ?>" alt="img">
          <p class="elipseme"><?php echo $recent_posts[0]["post_title"]; ?></p>
        </a>
      </div>
      <?php } ?>
      ...
      <div class="principales hlpr-mr-t">
        <a href="<?php echo get_permalink( $recent_posts[1]['ID'] ); ?>">
          <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $recent_posts[1]['ID'] ), 'nota-medium' ); ?>
      ...
      <div class="principales">
        <a href="<?php echo get_permalink( $recent_posts[2]['ID'] ); ?>">
          <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $recent_posts[2]['ID'] ), 'nota-medium' ); ?>
      ...
      <div class="principales">
        <a href="<?php echo get_permalink( $recent_posts[3]['ID'] ); ?>">
          <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $recent_posts[3]['ID'] ), 'nota-medium' ); ?>
